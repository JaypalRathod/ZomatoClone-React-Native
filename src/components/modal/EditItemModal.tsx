...
const EditItemModal: FC<{ item: any, restaurant: any, onClose: () => void, cus: any }> = ({ item, restaurant, onClose, cus }) => {
    ...
    const selectOptionHandler = (type: string, index: number) => {
        ...
        setData(prevData => {
            ...
            return {
                ...prevData, selectedOption: updatedSelectedOption, price: updatedPrice
            }
        })
    }
    ...
    const updateItemIntocart = async () => {
        ...
        console.log("customization : " + custonizedData)

        dispatch(updateCustomizableItem(custonizedData))
        onClose()
    };
        ...
        <View>
            <View style={styles.headerContainer}>
                <View style={styles.flexRowGap}>
                    ...
                    <CustomText fontSize={12} fontFamily='Okra-Medium'>{item?.name} (Edit)</CustomText>
                </View>
                <View style={styles.flexRowGap}>
                    <TouchableOpacity style={styles.icon}>
                        <Icon iconFamily='Ionicons' name='bookmark-outline' color={Colors.primary} size={16} />
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.icon}>
                        <Icon iconFamily='Ionicons' name='share-outline' color={Colors.primary} size={16} />
                    </TouchableOpacity>
                </View>
            </View>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <View style={styles.flexRowGap}>
                                            ...
                                            <Icon
                                                name={data?.selectedOption[customization.type] === i ? 'radiobox-marked' : 'radiobox-blank'}
            ...
            <View style={styles.footerContainer}>
                <View style={styles.selectedContainer}>
                    <ScalePress onPress={removeCartHandler} >
                        <Icon iconFamily='MaterialCommunityIcons' size={RFValue(13)} color={Colors.active} name='minus-thick' />
                    </ScalePress>
                    <AnimatedNumber
                        includeComma={false}
                    ...
                    <ScalePress onPress={addCartHandler}>
                        <Icon iconFamily='MaterialCommunityIcons' size={RFValue(13)} color={Colors.active} name='plus-thick' />
                    </ScalePress>
                </View>
