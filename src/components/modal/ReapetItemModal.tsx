...
const ReapetItemModal: FC<{ item: any; restaurant: any, onOpenAddModal: () => void, closeModal: () => void }> = ({
    item,
    restaurant,
    onOpenAddModal,
    closeModal
        ...
        <View>
            ...
            <View style={styles.noShadowFooterContainer}>
                <TouchableOpacity onPress={onOpenAddModal}>
                    <CustomText fontFamily='Okra-Bold' color={Colors.active} fontSize={11}>+ Add new customization</CustomText>
                </TouchableOpacity>
            </View>
        </View>
    )
...
export default ReapetItemModal