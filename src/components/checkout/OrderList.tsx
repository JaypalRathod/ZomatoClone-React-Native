...
import NonCustomizableCart from './NonCustomizableCart'

const OrderList: FC<{ cartItems: any, restaurant: any, totalItems: any }> = ({ cartItems, restaurant, totalItems }) => {
    return (
                    ...
                    return (
                        <View key={index} style={styles.subContainer} >
                            {item?.isCustomizable ?
                                ...
                                : 
                                <NonCustomizableCart item={item} restaurant={restaurant}  />
                            }
                        </View>
                    )
                })
