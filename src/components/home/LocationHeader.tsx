                ...
                <View style={styles.flexRowGap}>
                    ...
                    <View>
                        <TouchableOpacity style={styles.flexRow}>
                            <CustomText variant='h5' color={textColor} fontFamily='Okra-Bold' >Erangel, ponchiki</CustomText>
                            <Icon name='chevron-down' color={textColor} iconFamily='MaterialCommunityIcons' size={18} />
                        </TouchableOpacity>
                        <CustomText color={textColor} fontFamily='Okra-Medium'>Rajkot, Gujrat, india</CustomText>
                    </View>
                </View>
