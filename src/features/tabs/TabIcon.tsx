...
const TabIcon: FC<TabProps> = memo(({ name }) => {
    return (
        <View style={tabStyles} >
            <Image
                source={
                    name === 'Delivery' ? Delivery : name === 'Dining' ? Dining : name === 'Reorder' ? Reorder : Live
                }
                style={styles}
            />
...
const TabIconFocused: FC<TabProps> = memo(({ name }) => {
    ...
    return (
        <View style={tabStyles} >
            <Image
                source={
                    name === 'Delivery' ? DeliveryFocused : name === 'Dining' ? DiningFocused : name === 'Reorder' ? ReorderFocused : LiveFocused
                }
...
export const ReoderTabIcon: FC<IconProps> = ({ focused }) => {
    return focused ? <TabIconFocused name="Reoder" /> : <TabIcon name="Reoder" />
}
