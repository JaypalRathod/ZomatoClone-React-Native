        ...
        <Animated.View style={[
            ...
            {carts?.length > 1 && !isExpand && (
                <TouchableOpacity activeOpacity={0.9} onPress={() => setIsExpand(true)} style={styles.moreButton}>
                    <CustomText style={{ top: -1 }} color={Colors.active} fontSize={9}>
                        +{carts?.length - 1} more
                    </CustomText>

                    <Icon iconFamily='Ionicons' name='caret-up-outline' color={Colors.active} size={RFValue(10)} />
            ...
            {isExpand && (
                <TouchableOpacity style={styles.closeIcon} onPress={() => setIsExpand(false)}>
                    <Icon iconFamily='Ionicons' name='close' color={'#fff'} size={20} />
                ...
                <ScrollView contentContainerStyle={styles.scrollContainer}>
                    ...
                    <View style={styles.flexRowBetween}>
                        ...
                        <TouchableOpacity onPress={clearCart}>
                            <CustomText fontSize={10} fontFamily='Okra-Bold'>Clear All</CustomText>
                        </TouchableOpacity>
                    </View>
            ...
            {!isExpand && (
                <LinearGradient
                    ...
                    style={{ position: "absolute", width: '100%', height: 92, zIndex: -1, bottom: -20 }}
                />
            )}
